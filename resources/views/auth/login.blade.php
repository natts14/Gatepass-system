...
<body>
    <div class="row w-100 mt-3" id="loginBody">
        <div class="col">
        </div>
        <div class="col" id="">
            <div class="container bg-light text-dark rounded text-center mb-5" id="container"> 

                <form action="{{ route('login.custom') }}" method="POST" name="loginForm" class="needs-validation text-left p-4 w-100"   required>
                 @csrf
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" autocomplete="off" class="form-control" name="name" id="name" placeholder="Username" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="input-group mb-3">
                        ...
                        <a class="btn btn-dark text-center" id="register" href="{{ route('register-user') }}">Register New Account</a>
                    </div>
