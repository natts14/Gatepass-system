                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="firstname" class="font-weight-bold">FIRSTNAME</label>
                                        <input type="text" class="form-control-plaintext" name="firstname"  value="{{ $user->detail->firstname ?? '' }}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="middlename" class="font-weight-bold">MIDDLENAME</label>
                                        <input type="text" class="form-control-plaintext" name="middlename"  value="{{ $user->detail->middlename ?? '' }}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="lastname" class="font-weight-bold">SURNAME</label>
                                        <input type="text" class="form-control-plaintext" name="lastname"  value="{{ $user->detail->lastname ?? '' }}">
                                    </div>
                                </div>
